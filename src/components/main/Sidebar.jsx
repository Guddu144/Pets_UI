...
const useNavigation = () => {
  ...
  const links = [
    ...
    { name: 'Party', href: '/dashboard/ledger/expenses', current: isCurrent('/dashboard/trip/expenses'), icon: <IconMapSearch className="mr-3.5" color={isCurrent('/dashboard/trip/expenses') ? '#e6ecf3' : '#8aa6c8'} size={24} /> },
